        ...
        <svg width="151" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#a)">
                ...
                <g mask="url(#c)">
                    ...
                    <g filter="url(#d)">
                        <path
                            d="M4.885 22.594C1.65 17.634 2.206 10.92 6.557 6.564 10.912 2.202 17.63 1.647 22.586 4.9c.357.224.537.337.707.403a1.75 1.75 0 0 0 1.128.075c.18-.043.42-.153.903-.372 1.603-.73 3.85-2.299 4.64-1.51 1.212 1.214-2.435 7.521-10.696 15.792-8.261 8.27-14.561 12.156-15.773 10.943-.789-.79.778-3.276 1.507-4.88.219-.481.328-.722.371-.9.099-.413.077-.74-.077-1.136-.066-.172-.181-.354-.411-.72z"
                            fill="#FF0"
                        />
                    </g>
                </g>
            ...
            <defs>
                <radialGradient
                    ...
                    gradientTransform="rotate(45 -11.194 26.46) scale(15.3414)"
                >
                    <stop offset=".646" stopColor="#FF0" />
                    <stop offset="1" stopColor="#F37" />
                </radialGradient>
                <clipPath id="a">
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="2.441"
                        result="effect1_foregroundBlur_977_118400"
                    />
                </filter>
            </defs>
        </svg>
